...
isLOC_restricted1(p,[1 2]);  %Impose the constraint that  p should be in L^{Q_level}_{12}
isLOC_restricted1(p,[2 3]);  %Impose the constraint that  p should be in L^{Q_level}_{23}
isLOC_restricted1(p,[1 3]);  %Impose the constraint that  p should be in L^{Q_level}_{13}
